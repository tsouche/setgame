...
def refStepStarts_Dict():
    ...
    # The third Step is the same as teh first one.
    Dict.append( {'__class__': 'SetStep', 'turnCounter': '0',
        'playerID': 'None', 'playerName': '', 
        'table': ['00-00', '01-01', '02-02', '03-03', '04-04', '05-05', 
                  '06-06', '07-07', '08-08', '09-09', '10-10', '11-11'],
...
def refStepSecond_Dict():
    ...
    Dict_steps = []
    # This is a step generated by 'fromPrevious' on Cardset 1 and stepStart 1
    Dict_steps.append( {'set': [], '__class__': 'SetStep', 'table': ['00-00', '01-15', '02-02', '03-03', '04-04', '05-05', '06-14', '07-07', '08-08', '09-09', '10-10', '11-13'], 'turnCounter': '1', 'pick': ['00-16', '01-17', '02-18', '03-19', '04-20', '05-21', '06-22', '07-23', '08-24', '09-25', '10-26', '11-27', '12-28', '13-29', '14-30', '15-31', '16-32', '17-33', '18-34', '19-35', '20-36', '21-37', '22-38', '23-39', '24-40', '25-41', '26-42', '27-43', '28-44', '29-45', '30-46', '31-47', '32-48', '33-49', '34-50', '35-51', '36-52', '37-53', '38-54', '39-55', '40-56', '41-57', '42-58', '43-59', '44-60', '45-61', '46-62', '47-63', '48-64', '49-65', '50-66', '51-67', '52-68', '53-69', '54-70', '55-71', '56-72', '57-73', '58-74', '59-75', '60-76', '61-77', '62-78', '63-79', '64-80', '65-11'], 'used': ['00-01', '01-06', '02-12'], 'playerID': 'None', 'playerName': ''
        })
    # This is a step generated by 'fromPrevious' on Cardset 2 and stepStart 2
    Dict_steps.append({{'set': [], '__class__': 'SetStep', 'table': ['00-14', '01-01', '02-02', '03-13', '04-04', '05-05', '06-06', '07-07', '08-08', '09-12', '10-10', '11-11'], 'turnCounter': '1', 'pick': ['00-15', '01-16', '02-17', '03-18', '04-19', '05-20', '06-21', '07-22', '08-23', '09-24', '10-25', '11-26', '12-27', '13-28', '14-29', '15-30', '16-31', '17-32', '18-33', '19-34', '20-35', '21-36', '22-37', '23-38', '24-39', '25-40', '26-41', '27-42', '28-43', '29-44', '30-45', '31-46', '32-47', '33-48', '34-49', '35-50', '36-51', '37-52', '38-53', '39-54', '40-55', '41-56', '42-57', '43-58', '44-59', '45-60', '46-61', '47-62', '48-63', '49-64', '50-65', '51-66', '52-67', '53-68', '54-69', '55-70', '56-71', '57-72', '58-73', '59-74', '60-75', '61-76', '62-77', '63-78', '64-79', '65-80'], 'used': ['00-00', '01-03', '02-09'], 'playerID': 'None', 'playerName': ''
        })
    return [player, sets, Dict_steps]
...
def stepToString(step, cardset, tab=""):
    ...
    msg += tab+"- player: " + step.playerName +" ("+ str(step.playerID) + ")\n"
