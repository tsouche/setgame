...
def refSteps_Dict():
    ...
    Dict_steps[0].append({'__class__': 'SetStep', 'turnCounter': '25', 
        'playerID': 'None', 'nickname': '', 
        'table': ['00--1', '01--1', '02-80', '03--1', '04-56', '05--1', 
                  '06--1', '07-71', '08-79', '09--1', '10-61', '11-34'], 
        'set':   [], 
        'pick':  [],
        'used':  ['00-01', '01-06', '02-12', '03-15', '04-04', '05-05', 
                  '06-00', '07-16', '08-08', '09-21', '10-18', '11-09', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '1', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '2', 
        'nickname': 'Daisy', 'playerID': '57b9bffb124e9b2e056a765d', 
        'table': ['00-17', '01-16', '02-02', '03-13', '04-04', '05-05', 
                  '06-06', '07-07', '08-08', '09-15', '10-10', '11-11'],
        'set':   ['00', '06', '11'], 
        'pick':  ['00-18', '01-19', '02-20', '03-21', '04-22', '05-23', 
                  '06-24', '07-25', '08-26', '09-27', '10-28', '11-29', 
                  '12-30', '13-31', '14-32', '15-33', '16-34', '17-35', 
                  '18-36', '19-37', '20-38', '21-39', '22-40', '23-41', 
                  '24-42', '25-43', '26-44', '27-45', '28-46', '29-47', 
                  '30-48', '31-49', '32-50', '33-51', '34-52', '35-53', 
                  '36-54', '37-55', '38-56', '39-57', '40-58', '41-59', 
                  '42-60', '43-61', '44-62', '45-63', '46-64', '47-65', 
                  '48-66', '49-67', '50-68', '51-69', '52-70', '53-71', 
                  '54-72', '55-73', '56-74', '57-75', '58-76', '59-77', 
                  '60-78', '61-79', '62-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12'] 
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '3', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
        'table': ['00-20', '01-16', '02-02', '03-13', '04-04', '05-05', 
                  '06-19', '07-07', '08-08', '09-15', '10-10', '11-18'],
        'set':   ['01', '04', '11'], 
        'pick':  ['00-21', '01-22', '02-23', '03-24', '04-25', '05-26', 
                  '06-27', '07-28', '08-29', '09-30', '10-31', '11-32', 
                  ...
                  '36-57', '37-58', '38-59', '39-60', '40-61', '41-62', 
                  '42-63', '43-64', '44-65', '45-66', '46-67', '47-68', 
                  '48-69', '49-70', '50-71', '51-72', '52-73', '53-74', 
                  '54-75', '55-76', '56-77', '57-78', '58-79', '59-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11'] 
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '4', 
        'nickname': 'Riri', 'playerID': '57b9a003124e9b13e6759bdb', 
        'table': ['00-20', '01-23', '02-02', '03-13', '04-22', '05-05', 
                  '06-19', '07-07', '08-08', '09-15', '10-10', '11-21'],
        'set':   ['01', '04', '08'], 
        'pick':  ['00-24', '01-25', '02-26', '03-27', '04-28', '05-29', 
                  '06-30', '07-31', '08-32', '09-33', '10-34', '11-35', 
                  '12-36', '13-37', '14-38', '15-39', '16-40', '17-41', 
                  '18-42', '19-43', '20-44', '21-45', '22-46', '23-47', 
                  '24-48', '25-49', '26-50', '27-51', '28-52', '29-53', 
                  '30-54', '31-55', '32-56', '33-57', '34-58', '35-59', 
                  '36-60', '37-61', '38-62', '39-63', '40-64', '41-65', 
                  '42-66', '43-67', '44-68', '45-69', '46-70', '47-71', 
                  '48-72', '49-73', '50-74', '51-75', '52-76', '53-77', 
                  '54-78', '55-79', '56-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '5', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-20', '01-26', '02-02', '03-13', '04-25', '05-05', 
                  '06-19', '07-07', '08-24', '09-15', '10-10', '11-21'],
        'set':   ['05', '06', '07'], 
        'pick':  ['00-27', '01-28', '02-29', '03-30', '04-31', '05-32', 
                  '06-33', '07-34', '08-35', '09-36', '10-37', '11-38', 
                  '12-39', '13-40', '14-41', '15-42', '16-43', '17-44', 
                  '18-45', '19-46', '20-47', '21-48', '22-49', '23-50', 
                  '24-51', '25-52', '26-53', '27-54', '28-55', '29-56', 
                  '30-57', '31-58', '32-59', '33-60', '34-61', '35-62', 
                  '36-63', '37-64', '38-65', '39-66', '40-67', '41-68', 
                  '42-69', '43-70', '44-71', '45-72', '46-73', '47-74', 
                  '48-75', '49-76', '50-77', '51-78', '52-79', '53-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '6', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-20', '01-26', '02-02', '03-13', '04-25', '05-29', 
                  '06-28', '07-27', '08-24', '09-15', '10-10', '11-21'],
        'set':   ['02', '05', '11'], 
        'pick':  ['00-30', '01-31', '02-32', '03-33', '04-34', '05-35', 
                  '06-36', '07-37', '08-38', '09-39', '10-40', '11-41', 
                  '12-42', '13-43', '14-44', '15-45', '16-46', '17-47', 
                  '18-48', '19-49', '20-50', '21-51', '22-52', '23-53', 
                  '24-54', '25-55', '26-56', '27-57', '28-58', '29-59', 
                  '30-60', '31-61', '32-62', '33-63', '34-64', '35-65', 
                  '36-66', '37-67', '38-68', '39-69', '40-70', '41-71', 
                  '42-72', '43-73', '44-74', '45-75', '46-76', '47-77', 
                  '48-78', '49-79', '50-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '7', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
        'table': ['00-20', '01-26', '02-32', '03-13', '04-25', '05-31', 
                  '06-28', '07-27', '08-24', '09-15', '10-10', '11-30'],
        'set':   ['00', '02', '06'], 
        'pick':  ['00-33', '01-34', '02-35', '03-36', '04-37', '05-38', 
                  '06-39', '07-40', '08-41', '09-42', '10-43', '11-44', 
                  '12-45', '13-46', '14-47', '15-48', '16-49', '17-50', 
                  '18-51', '19-52', '20-53', '21-54', '22-55', '23-56', 
                  '24-57', '25-58', '26-59', '27-60', '28-61', '29-62', 
                  '30-63', '31-64', '32-65', '33-66', '34-67', '35-68', 
                  '36-69', '37-70', '38-71', '39-72', '40-73', '41-74', 
                  '42-75', '43-76', '44-77', '45-78', '46-79', '47-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                  '18-02', '19-29', '20-21']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '8', 
        'nickname': 'Riri', 'playerID': '57b9a003124e9b13e6759bdb', 
        'table': ['00-35', '01-26', '02-34', '03-13', '04-25', '05-31', 
                  '06-33', '07-27', '08-24', '09-15', '10-10', '11-30'],
        'set':   ['02', '04', '08'], 
        'pick':  ['00-36', '01-37', '02-38', '03-39', '04-40', '05-41', 
                  '06-42', '07-43', '08-44', '09-45', '10-46', '11-47', 
                  '12-48', '13-49', '14-50', '15-51', '16-52', '17-53', 
                  '18-54', '19-55', '20-56', '21-57', '22-58', '23-59', 
                  '24-60', '25-61', '26-62', '27-63', '28-64', '29-65', 
                  '30-66', '31-67', '32-68', '33-69', '34-70', '35-71', 
                  '36-72', '37-73', '38-74', '39-75', '40-76', '41-77', 
                  '42-78', '43-79', '44-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                  '18-02', '19-29', '20-21', '21-20', '22-32', '23-28'] 
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '9', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-35', '01-26', '02-38', '03-13', '04-37', '05-31', 
                  '06-33', '07-27', '08-36', '09-15', '10-10', '11-30'],
        'set':   ['00', '02', '05'], 
        'pick':  ['00-39', '01-40', '02-41', '03-42', '04-43', '05-44', 
                  '06-45', '07-46', '08-47', '09-48', '10-49', '11-50', 
                  '12-51', '13-52', '14-53', '15-54', '16-55', '17-56', 
                  '18-57', '19-58', '20-59', '21-60', '22-61', '23-62', 
                  '24-63', '25-64', '26-65', '27-66', '28-67', '29-68', 
                  '30-69', '31-70', '32-71', '33-72', '34-73', '35-74', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '10', 
        'nickname': 'Fifi', 'playerID': '57b9a003124e9b13e6759bdc', 
        'table': ['00-41', '01-26', '02-40', '03-13', '04-37', '05-39', 
                  '06-33', '07-27', '08-36', '09-15', '10-10', '11-30'],
        'set':   ['00', '01', '10'], 
        'pick':  ['00-42', '01-43', '02-44', '03-45', '04-46', '05-47', 
                  '06-48', '07-49', '08-50', '09-51', '10-52', '11-53', 
                  '12-54', '13-55', '14-56', '15-57', '16-58', '17-59', 
                  '18-60', '19-61', '20-62', '21-63', '22-64', '23-65', 
                  '24-66', '25-67', '26-68', '27-69', '28-70', '29-71', 
                  '30-72', '31-73', '32-74', '33-75', '34-76', '35-77', 
                  '36-78', '37-79', '38-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '11', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-44', '01-43', '02-40', '03-13', '04-37', '05-39', 
                  '06-33', '07-27', '08-36', '09-15', '10-42', '11-30'],
        'set':   ['00', '02', '06'], 
        'pick':  ['00-45', '01-46', '02-47', '03-48', '04-49', '05-50', 
                  '06-51', '07-52', '08-53', '09-54', '10-55', '11-56', 
                  '12-57', '13-58', '14-59', '15-60', '16-61', '17-62', 
                  '18-63', '19-64', '20-65', '21-66', '22-67', '23-68', 
                  '24-69', '25-70', '26-71', '27-72', '28-73', '29-74', 
                  '30-75', '31-76', '32-77', '33-78', '34-79', '35-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                  '18-02', '19-29', '20-21', '21-20', '22-32', '23-28', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '12', 
        'nickname': 'Donald', 'playerID': '57b8529a124e9b6187cf6c2a', 
        'table': ['00-47', '01-43', '02-46', '03-13', '04-37', '05-39', 
                  '06-45', '07-27', '08-36', '09-15', '10-42', '11-30'],
        'set':   ['00', '02', '03'], 
        'pick':  ['00-48', '01-49', '02-50', '03-51', '04-52', '05-53', 
                  '06-54', '07-55', '08-56', '09-57', '10-58', '11-59', 
        ...
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  ...
                  '18-02', '19-29', '20-21', '21-20', '22-32', '23-28', 
                  '24-34', '25-25', '26-24', '27-35', '28-38', '29-31', 
                  '30-41', '31-26', '32-10', '33-44', '34-40', '35-33']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '13', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
        'table': ['00-50', '01-43', '02-49', '03-48', '04-37', '05-39', 
                  '06-45', '07-27', '08-36', '09-15', '10-42', '11-30'],
        'set':   ['01', '08', '11'], 
        'pick':  ['00-51', '01-52', '02-53', '03-54', '04-55', '05-56', 
                  '06-57', '07-58', '08-59', '09-60', '10-61', '11-62', 
                  '12-63', '13-64', '14-65', '15-66', '16-67', '17-68', 
                  '18-69', '19-70', '20-71', '21-72', '22-73', '23-74', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '14', 
        'nickname': 'Donald', 'playerID': '57b8529a124e9b6187cf6c2a', 
        'table': ['00-50', '01-53', '02-49', '03-48', '04-37', '05-39', 
                  '06-45', '07-27', '08-52', '09-15', '10-42', '11-51'],
        'set':   ['04', '05', '08'], 
        'pick':  ['00-54', '01-55', '02-56', '03-57', '04-58', '05-59', 
                  '06-60', '07-61', '08-62', '09-63', '10-64', '11-65', 
                  '12-66', '13-67', '14-68', '15-69', '16-70', '17-71', 
                  '18-72', '19-73', '20-74', '21-75', '22-76', '23-77', 
                  '24-78', '25-79', '26-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '15', 
        'nickname': 'Daisy', 'playerID': '57b9bffb124e9b2e056a765d', 
        'table': ['00-50', '01-53', '02-49', '03-48', '04-56', '05-55', 
                  '06-45', '07-27', '08-54', '09-15', '10-42', '11-51'],
        'set':   ['03', '04', '06'], 
        'pick':  ['00-57', '01-58', '02-59', '03-60', '04-61', '05-62', 
                  '06-63', '07-64', '08-65', '09-66', '10-67', '11-68', 
                  '12-69', '13-70', '14-71', '15-72', '16-73', '17-74', 
                  '18-75', '19-76', '20-77', '21-78', '22-79', '23-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                  '18-02', '19-29', '20-21', '21-20', '22-32', '23-28', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '16', 
        'nickname': 'Donald', 'playerID': '57b8529a124e9b6187cf6c2a', 
        'table': ['00-50', '01-53', '02-49', '03-59', '04-58', '05-55', 
                  '06-57', '07-27', '08-54', '09-15', '10-42', '11-51'],
        'set':   ['00', '03', '11'], 
        'pick':  ['00-60', '01-61', '02-62', '03-63', '04-64', '05-65', 
                  '06-66', '07-67', '08-68', '09-69', '10-70', '11-71', 
        ...
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  ...
                  '30-41', '31-26', '32-10', '33-44', '34-40', '35-33', 
                  '36-47', '37-46', '38-13', '39-43', '40-36', '41-30', 
                  '42-37', '43-39', '44-52', '45-48', '46-56', '47-45']
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '17', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
        'table': ['00-62', '01-53', '02-49', '03-61', '04-58', '05-55', 
                  '06-57', '07-27', '08-54', '09-15', '10-42', '11-60'],
        'set':   ['01', '06', '09'], 
        'pick':  ['00-63', '01-64', '02-65', '03-66', '04-67', '05-68', 
                  '06-69', '07-70', '08-71', '09-72', '10-73', '11-74', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '18', 
        'nickname': 'Fifi', 'playerID': '57b9a003124e9b13e6759bdc', 
        'table': ['00-62', '01-65', '02-49', '03-61', '04-58', '05-55', 
                  '06-64', '07-27', '08-54', '09-63', '10-42', '11-60'],
        'set':   ['01', '07', '08'], 
        'pick':  ['00-66', '01-67', '02-68', '03-69', '04-70', '05-71', 
                  '06-72', '07-73', '08-74', '09-75', '10-76', '11-77', 
                  '12-78', '13-79', '14-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '19', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-62', '01-68', '02-49', '03-61', '04-58', '05-55', 
                  '06-64', '07-67', '08-66', '09-63', '10-42', '11-60'],
        'set':   ['02', '05', '11'], 
        'pick':  ['00-69', '01-70', '02-71', '03-72', '04-73', '05-74', 
                  '06-75', '07-76', '08-77', '09-78', '10-79', '11-80'], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                  '18-02', '19-29', '20-21', '21-20', '22-32', '23-28', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '20', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-62', '01-68', '02-71', '03-61', '04-58', '05-70', 
                  '06-64', '07-67', '08-66', '09-63', '10-42', '11-69'],
        'set': ['01', '02', '07'], 
        'pick': ['00-72', '01-73', '02-74', '03-75', '04-76', '05-77', 
                 '06-78', '07-79', '08-80'], 
        'used': ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                 '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                 '12-23', '13-22', '14-08', '15-05', '16-19', '17-07', 
                 ...
                 '42-37', '43-39', '44-52', '45-48', '46-56', '47-45', 
                 '48-50', '49-59', '50-51', '51-53', '52-57', '53-15', 
                 '54-65', '55-27', '56-54', '57-49', '58-55', '59-60'], 
        })
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '21', 
        'nickname': 'Mickey', 'playerID': '57b9a003124e9b13e6759bda', 
        'table': ['00-62', '01-74', '02-73', '03-61', '04-58', '05-70', 
                  '06-64', '07-72', '08-66', '09-63', '10-42', '11-69'],
        'set':   ['01', '02', '04'], 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '22', 
        'nickname': 'Loulou', 'playerID': '57b9bffb124e9b2e056a765c', 
        'table': ['00-62', '01-77', '02-76', '03-61', '04-75', '05-70', 
                  '06-64', '07-72', '08-66', '09-63', '10-42', '11-69'],
        'set':   ['03', '08', '10'], 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '23', 
        'nickname': 'Donald', 'playerID': '57b8529a124e9b6187cf6c2a', 
        'table': ['00-62', '01-77', '02-76', '03-80', '04-75', '05-70', 
                  '06-64', '07-72', '08-79', '09-63', '10-78', '11-69'],
        'set':   ['02', '04', '10'], 
        'pick':  [], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
    ...
    Dict_steps[1].append({'__class__': 'SetStep', 'turnCounter': '24', 
        'nickname': '', 'playerID': 'None',
        'table': ['00-62', '01-77', '02--1', '03-80', '04--1', '05-70', 
                  '06-64', '07-72', '08-79', '09-63', '10--1', '11-69'], 
        'set':   [], 
        'pick':   [], 
        'used':  ['00-00', '01-03', '02-09', '03-14', '04-01', '05-12', 
                  '06-17', '07-06', '08-11', '09-16', '10-04', '11-18', 
                  ...
                  '54-65', '55-27', '56-54', '57-49', '58-55', '59-60', 
                  '60-68', '61-71', '62-67', '63-74', '64-73', '65-58', 
                  '66-61', '67-66', '68-42', '69-76', '70-75', '71-78'], 
        })
    return Dict_steps
